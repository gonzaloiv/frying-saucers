...
public class EventManager : Singleton<EventManager> {
    ...
    public static void StartListening<T> (EventDelegate<T> del) where T : EventArgs {
    ...
    public static void StopListening<T> (EventDelegate<T> del) where T : EventArgs {
    ...
    public static void TriggerEvent (EventArgs e) {
        EventDelegate del;
